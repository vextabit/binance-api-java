 ...
 */
public class NettyAuthenticationInterceptor implements Consumer<RequestBuilder>, SignatureCalculator {

  private final String apiKey;

  private final String secret;

  public NettyAuthenticationInterceptor(String apiKey, String secret) {
    this.apiKey = apiKey;
    this.secret = secret;
  }
