...
public final class Util {
   ...
   */
  public static final List<String> FIAT_CURRENCY = Collections.unmodifiableList(Arrays.asList("USDT", "USD", "EUR", "BUSD", "PAX", "BKRW",
      "TUSD", "USDC", "TRY", "AUD", "BIDR", "BRL", "DAI", "GBP", "IDRT", "NGN", "RUB", "UAH", "ZAR", "BVND"));
